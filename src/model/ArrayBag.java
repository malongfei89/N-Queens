...
// File: ArrayBag.java from the package edu.colorado.collections
	// Additional java doc documentation is available from the ArrayBag link in:
	...
	public class ArrayBag implements Cloneable
	{
	   ...
	   **/   
	   public ArrayBag( )
	   {
	      ...
	      manyItems = 0;
	      data = new Location[INITIAL_CAPACITY];
	   }
	   ...
	   **/   
	   public ArrayBag(int initialCapacity)
	   {
	      ...
	      data = new Location[initialCapacity];
	      manyItems = 0;
	   }
	   ...
	   **/
	   public void add(Location element)
	   {
	      ...
	      data[manyItems] = new Location(element.getX(), element.getY());
	      manyItems++;
	   }
	   ...
	   *   arithmetic overflow.
	   **/
	   public void addMany(Location... elements)
	   {
	   ...
	   **/ 
	   ...
	   {  // Clone an ArrayBag object.
	      ...
	      for(int i = 0; i< manyItems;i++) {
	    	  answer.data[i] = new Location (data[i].getX(), data[i].getY());
	      }
	   ...
	   **/
	   public int countOccurrences(Location target)
	   {
	      int answer;
	      int index;
	   ...
	   **/
	   ...
	   {
		   Location biggerArray[ ];
	      
	      if (data.length < minimumCapacity)
	      {
	         biggerArray = new Location[minimumCapacity];
	   ...
	   **/
	   	   public boolean remove(Location target)
	   {
	   ...
	   **/
	   ...
	   {
		   Location[ ] trimmedArray;
	      
	      if (data.length != manyItems)
	      {
	         trimmedArray = new Location[manyItems];
